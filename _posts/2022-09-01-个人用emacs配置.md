...
- 需安装字体 Nerd Font(brew 太慢可以直接去字体库下载后安装)
...
- 建议使用 iterm2（终端色彩下能好看一点） [iterm2](https://www.iterm2.com/downloads.html)(alacritty + fish 也不错)
...
- 推荐使用 ***emacs28.2分支*** ，该版本为目前稳定版本，弃用eglot，改用[lsp-bridge](https://github.com/manateelazycat/lsp-bridge)目前使用良好，支持语言足矣。
